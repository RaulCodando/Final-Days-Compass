...
# 3. Compila o teste diretamente para a pasta build/
...
# 5. Compila a main do teste diretamente para a pasta build/
build/main_test.o: tests/main_test.c
	gcc -c tests/main_test.c -o build/main_test.o -Isrc -Itests

# 6. Busca os arquivos .o dentro de build/ e gera o executável lá dentro
test: build/sprite.o build/renderer.o build/test_sprite.o build/test_renderer.o build/main_test.o
	gcc -o tests/run_tests build/main_test.o build/test_sprite.o build/sprite.o build/test_renderer.o build/renderer.o
