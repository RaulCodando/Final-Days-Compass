...
# 4. Compila o teste diretamente para a pasta build/
...
# 6. Compila a main do teste diretamente para a pasta build/
...
# 8. Busca os arquivos .o dentro de build/ e gera o executável lá dentro
test: build/sprite.o build/renderer.o build/test_sprite.o build/test_renderer.o build/main_test.o build/game.o build/test_game.o
	gcc -o tests/run_tests build/main_test.o build/test_sprite.o build/sprite.o build/test_renderer.o build/renderer.o build/game.o build/test_game.o
