...
SRC_SOURCES   := $(wildcard $(SRC_DIR)/*.c) $(wildcard $(SRC_DIR)/*/*.c) $(wildcard $(SRC_DIR)/*/*/*.c)
TEST_SOURCES  := $(wildcard $(TEST_DIR)/*.c) $(wildcard $(TEST_DIR)/*/*.c) $(wildcard $(TEST_DIR)/*/*/*.c)
